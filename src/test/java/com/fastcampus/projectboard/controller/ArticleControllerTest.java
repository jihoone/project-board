...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 헤시태그 검색 페이지 - 정상 호출, 해시태그 입력")
    @Test
    ...
    @WithUserDetails(value = "jihoonTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
